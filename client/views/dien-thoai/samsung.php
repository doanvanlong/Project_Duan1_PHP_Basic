    ...
    <div class="col-9">
        <div class="box-dien-thoai">
            <div style=" border-radius:5px ;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;" class="p-4 bg-white box-dien-thoai-title d-flex align-items-center">
                <h1 class="mb-0 font-size-2-5">Điện thoại Samsung </h1>
                <?php
                // đếm tất cả điện thoại
                $dt_samsung_count = dien_thoai_samsung_Count_All();
                ?>
                <span class="font-size-1-8 text-secondary pl-3">(<?= $dt_samsung_count; ?> sản phẩm)</span>
            </div>
            <div class="box-dien-thoai-content bg-white p-4 my-5" style="border-radius:5px ;box-shadow: rgba(0, 0, 0, 0.05) 0px 6px 24px 0px, rgba(0, 0, 0, 0.08) 0px 0px 0px 1px;">
                ...
                <div class="box-dien-thoai-content-product py-5">
                    <div class="tab__menu-product-content py-4">
                        ...
                        <div class="row">
                            <?php
                            $dien_thoai_samsung = dien_thoai_Samsung_Query_9();
                            foreach ($dien_thoai_samsung as $dien_thoai_samsung) { ?>
                                <div class="col-4">
                                    <a href="san-pham?id=<?=$dien_thoai_samsung['id_sp']?>&name=<?=$dien_thoai_samsung['ten_sp']?>" class="tab__menu-product-content-newproduct">
                                        <div class="tab__menu-product-content-newproduct-img" style="background-image:url('<?= $CONTENT_UPLOAD ?>/<?= $dien_thoai_samsung['hinh_anh'] ?>')">
                                            <!-- Nhãn giảm giá -->
                                        ...
                                        <div class="px-4 pt-1 pb-5">
                                            ...
                                            <div class="tab__menu-product-newproduct-price d-flex">
                                                <b class="tab__menu-product-newproduct-newprice pt-2">
                                                    <?= number_format($dien_thoai_samsung['don_gia'], 0, ',', '.') . 'đ'; ?>
                                                </b>
