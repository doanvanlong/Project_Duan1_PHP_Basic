...
if (isset($_POST['checkout_success'])) {
    ...
    //dùng để lôi id kh đã có và thêm vào lại DB tranh bị mất kh trc , Ko dùng update mà Insert
    ...
    //    nếu thanh toán onl thành công thì quay lại update thành thành công 
    $date = Date('Y-m-d');
