$(document).ready(function () {
  ...
  // làm tạm:  do ko nhận main js
  //  Update sản phẩm phần xoá màu sắc more add

  //Delete Màu sắc More
  $(".click_xoa-mau-sac").click(function () {
    var id_ms_phone = $(this).data("id_ms");
    $.post(
      "../admin/xu-ly/san-pham/delete-ms-dl-more-add.php",
      { id_ms_phone: id_ms_phone },
      function (data) {
        if (data == 1) {
          toast({
            title: "Thành công",
  ...
  //Delete Dung lượng More
  $(".click_xoa-dung-luong").click(function () {
    var id_dl_phone = $(this).data("id_dl");
    $.post(
      "../admin/xu-ly/san-pham/delete-ms-dl-more-add.php",
      { id_dl_phone: id_dl_phone },
      function (data) {
        if (data == 1) {
          toast({
            title: "Thành công",
