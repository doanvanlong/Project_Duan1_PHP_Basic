                ...
                <li class="navigation__items">
                    <div class="navigation__link d-flex align-items-center cursor-pointer">
                        ...
                        <span style="white-space: nowrap;">Danh mục
                            <span class="box__icon-dropdown"><i
                                    class="icon__dropdown fas fa-angle-down"></i></span></span>
                    </div>
                    <div class="sub-menu">
            ...
            <div class="top__bar">
                ...
                <div class="user ">
                    <div class="dropdown d-flex align-items-center">
                        ...
                        <div class="user__name pl-2 dropdown-toggle" style="cursor: pointer;font-weight: 600;"
