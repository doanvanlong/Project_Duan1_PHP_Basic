<h3 class="alert bg-secondary text-light heading-cate">Chương trình mua kèm deal sốc</h3>
<div class="giam-gia bg-light">
    <div class="row">
        <div class="col-12">
            <p class="alert alert-warning">Hãy bắt đầu tạo Chương Trình Giảm Giá mua kèm deal sốc cho một sản phẩm chính</p>
            <a href="add-deal-soc" class="btn btn-success textwhite my-3"><i class="fas fa-plus"></i> Tạo Chương Trình Mua Kèm Deal Sốc mới</a>
                ...
                <div class="giam-gia-tab-status my-3">
                    ...
                    <div class="tab-content py-4" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="dang-dien-ra" role="tabpanel" aria-labelledby="dang-dien-ra-tab">
                            ...
                            <?php
                            $list_id_dang_dien_ra = deal_soc_Select_Ok_Id_Km_Dang_Dien_Ra();
                                ...
                                <table class="table table-bordered table-striped my-4">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="text-secondary">Sản phẩm chính</th>
                                            <th scope="col" class="text-secondary">Sản phẩm mua kèm</th>
                                    ...
                                    <tbody id="myTable">
                                        <?php
                                        $list_id_km = deal_soc_Select_Ok_Id_Km_Dang_Dien_Ra();
                                        foreach ($list_id_km as $id_km) {
                                            $info_all = deal_soc_Query_By_Id_Km_Dang_Dien_Ra($id_km['id_khuyen_mai']);
                                            $mang_anh = [];
                                            $anh_sp_chinh = $info_all[0]['id_sp_chinh'];
                                            $info_sp_chinh = san_pham_QueryOne($anh_sp_chinh);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><img style="width:50px;" src="<?= $CONTENT_UPLOAD ?>/<?= $info_sp_chinh['hinh_anh'] ?>" alt=""></td>
                                                <td>
                                                    <?php
                                                    $i = 0;
                                                    $dem = count($mang_anh);
                        ...
                        <div class="tab-pane fade" id="da-ket-thuc" role="tabpanel" aria-labelledby="da-ket-thuc-tab">
                            ...
                            <!-- nếu chưa có chương trình đã kết thúc nào -->
                            <?php
                            $list_id_da_ket_thuc = deal_soc_Select_Ok_Id_Km_Da_Ket_Thuc();
                            if (count($list_id_da_ket_thuc) > 0) { ?>
                                ...
                                <table class="table table-bordered table-striped my-4">
                                    ...
                                    <tbody id="myTable">
                                        <?php
                                        $list_id_km = deal_soc_Select_Ok_Id_Km_Da_Ket_Thuc();
                                        foreach ($list_id_km as $id_km) {
                                            $info_all = deal_soc_Query_By_Id_Km_Da_Ket_Thuc($id_km['id_khuyen_mai']);
                                            $mang_anh = [];
                                            $anh_sp_chinh = $info_all[0]['id_sp_chinh'];
                                            $info_sp_chinh = san_pham_QueryOne($anh_sp_chinh);
                                            foreach ($info_all as $info) {
                                        ...
                                        ?>
                                            <tr>
                                                <td class="d-flex flex-column">
                                                    <b class=""><?= $info_km['ten_chuong_trinh'] ?></b>
                                                    <small class="text-secondary">Đã kết thúc</small>
