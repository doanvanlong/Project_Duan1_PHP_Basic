        ...
        if (!empty($list_orders)) { 
                ...
                if ($trangThai == "daxacnhan") {
                    echo '<td class="align-middle"><span style="font-weight:bold; color: var(--success);">Đã Xác Nhận</span></td>
                                    <td class="align-middle">
                                        ...
                                        <button type="input" class="btn btn-primary" id="order-details"><a href="order-details?ID=' . $idHoaDon . '" style="color: white;">Xem Chi Tiết</a></button>
                                        </div>
                                    </td>
                                    </tr>
                                    </tbody>';
            ...
            echo '
                            ...
                            <div style="text-align: center;">
                                ...
                                <h4 style="padding: 1em 1em;">Không có đơn hàng nào đã xác nhận.</h4>
                            </div>
                            <hr>';
        }
        ?>
