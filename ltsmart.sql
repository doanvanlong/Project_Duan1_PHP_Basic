...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 06, 2021 lúc 04:04 AM
...
(38, 13, 'chuathanhtoan', 'daxacnhan', 0, 24196200, '2021-12-04', '0000-00-00', '493800'),
(40, 14, 'chuathanhtoan', 'chuaxacnhan', 0, 24190000, '2021-12-04', '0000-00-00', '500000'),
(41, 13, 'chuathanhtoan', 'huy', 0, 24690000, '2021-12-04', '0000-00-00', '0'),
(47, 13, 'chuathanhtoan', 'chuaxacnhan', 0, 27400000, '2021-12-05', '0000-00-00', '0');
...
(13, 'longdv', '87654321', 'Long Đoàn', 'Đoàn Văn Long PD05236 (2).jpg', '0378854216', 'longlongdoan1998@gmail.com', '214 Âu Cơ - Hoà Khánh Bắc - Liên Chiểu - Tp Đà Nẵng', 1),
(14, 'thangpham', '12345678', 'Thắng Phạm', NULL, '032132112', NULL, 'abc', 0),
(15, 'longdv1', '12345678', 'Long', '', '', '', '', 0),
(26, 'bglight', '12345678', 'Bg Light', '', '', NULL, '', 0);
...
(18, 'Giảm giá 500k', 1, '2021-12-02 19:40:00', '2021-12-31 14:00:00', 50, 1, 6),
(39, 'Giảm giá 20%  ', 1, '2021-12-02 23:37:00', '2021-12-31 23:37:00', 100, 1, 2),
(40, 's', 1, '2021-12-03 16:40:00', '2021-12-03 20:10:41', 2, 0, 0),
(41, 'giam gia', 1, '2021-12-03 17:06:00', '2021-12-03 18:13:30', 20, 0, 1),
(42, 'Tri ân khách hàng1', 2, '2021-12-04 17:20:00', '2021-12-05 18:06:25', 50, 0, 2),
...
(60, 'Giảm 500k', 2, '2021-12-05 18:06:00', '2021-12-31 18:06:00', 20, 1, 0);
...
(1, 42, '13,14', 'LTS0011', 2, 500000, 10000000),
...
(13, 60, NULL, 'LTS02', 2, 500000, 12000000);
...
(110, 109, 15, 5, '   Cho 5 sao luôn                             ', '2021-12-05');
...
(104, 48, 48, 'Tai nghe có dây choàng đầu có mic i.value T-139', '1054568922.jpg', 239000, 22, '2021-11-22', '', 9),
...
(112, 48, 52, 'Ốp lưng iPhone 13 Pro Max Leather Case with MagSafe ', '663173266.jpg', 1200000, 44, '2021-11-22', '', 23),
(113, 48, 51, 'SẠC DỰ PHÒNG HYPERJUICE USB-C + LIGHTNING 18W 10000mAh', '671719120.jpg', 1400000, 23, '2021-11-22', '', 71),
(114, 48, 48, 'ai nghe chơi game không dây Corsair Virtuoso RGB SE ', '1550058048.jpg', 4300000, 55, '2021-11-22', '', 3),
...
--
ALTER TABLE `binh_luan_pro`
  MODIFY `id_bl_pro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
...
--
ALTER TABLE `giam_gia`
  MODIFY `id_giam_gia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT cho bảng `hoa_don`
--
ALTER TABLE `hoa_don`
  MODIFY `id_hoa_don` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT cho bảng `hoa_don_chi_tiet`
--
ALTER TABLE `hoa_don_chi_tiet`
  MODIFY `id_hoa_don_chi_tiet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
...
--
ALTER TABLE `khuyen_mai`
  MODIFY `id_khuyen_mai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `ma_giam_gia`
  MODIFY `id_ma_giam_gia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT cho bảng `rating_sp`
--
ALTER TABLE `rating_sp`
  MODIFY `id_rating` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
...
--
ALTER TABLE `san_pham`
  MODIFY `id_sp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
...
--
ALTER TABLE `thong_bao_user`
  MODIFY `id_thong_bao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT cho bảng `thong_bao_user_detail`
--
ALTER TABLE `thong_bao_user_detail`
  MODIFY `id_thong_bao_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
