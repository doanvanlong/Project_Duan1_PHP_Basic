...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 26, 2021 lúc 03:35 AM
...
(14, 108, 13, 4, '      Sản phẩm tốt                       ', '2021-11-25'),
(15, 108, 13, 4, 'Máy dùng tốt, nhân viên tư vấn rất thân thiện                                ', '2021-11-25'),
(58, 108, 13, 4, '      rất tuyệt vời                          ', '2021-11-25'),
...
(21, 15, 13, '   Cảm ơn bạn đã tin tưởng shop chúng tôi                             ', '2021-11-25'),
...
(23, 18, 13, '                    ss            ', '2021-11-25'),
(24, 15, 13, '          ss                      ', '2021-11-25'),
...
(113, 48, 51, 'SẠC DỰ PHÒNG HYPERJUICE USB-C + LIGHTNING 18W 10000mAh', '671719120.jpg', 1400000, 23, '2021-11-22', '', 3),
...
--
ALTER TABLE `binh_luan_pro`
  MODIFY `id_bl_pro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `rating_sp`
  MODIFY `id_rating` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT cho bảng `reply_binh_luan_pro`
--
ALTER TABLE `reply_binh_luan_pro`
  MODIFY `id_reply` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
