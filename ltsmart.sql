...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 30, 2021 lúc 04:09 AM
...
(13, 'longdv', '12345678', 'Long Đoàn', NULL, '0378854216', 'longlongdoan1998@gmail.com', '214 Âu Cơ - Hoà Khánh Bắc - Liên Chiểu - Tp Đà Nẵng', 1),
...
--
ALTER TABLE `hoa_don`
  MODIFY `id_hoa_don` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT cho bảng `hoa_don_chi_tiet`
--
ALTER TABLE `hoa_don_chi_tiet`
  MODIFY `id_hoa_don_chi_tiet` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
